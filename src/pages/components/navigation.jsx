...
function Navigation() {
    ...
    return (
        <nav
            className='fixed top-0 left-0 right-0 z-50 transition-all duration-300 w-fit mx-auto mt-4 rounded-full backdrop-blur-sm bg-black/20 shadow-2xl shadow-white/5'
        >
